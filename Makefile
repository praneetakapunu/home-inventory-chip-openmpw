...
cocotb-verify-all-rtl: 
	@(cd $(PROJECT_ROOT)/verilog/dv/cocotb && $(PROJECT_ROOT)/venv-cocotb/bin/caravel_cocotb -di $(PROJECT_ROOT)/verilog/dv/cocotb/design_info.yaml -tl user_proj_tests/user_proj_tests.yaml )
